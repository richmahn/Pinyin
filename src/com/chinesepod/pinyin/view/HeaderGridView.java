 ...
 * Author: Richard Mahn
 * 
 * View for the header of the Reference Chart
 */
...
public class HeaderGridView extends GridView implements OnScrollListener{
	...
	/**
     * A class that represents a fixed view in a list, for example a mHeader at the top
    ...
    public void addHeaderView(View v, Object data, boolean isSelectable) {
        ...
        // in the case of re-adding a mHeader view, or adding one later on,
	...
	public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
		if(this.getAdapter()!=null){
			...
			if(count > 0 && firstVisibleItem == 0){
				...
				// need to check to see if should show mHeader
